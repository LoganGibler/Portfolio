      ...
      <div className="fade-in-effect grow">
        ...
        <div className="flex flex-col my-1 px-2">
          ...
          <li className="text-sm mt-1">
            Created scripts to automate tasks for retail support team and other
            datacenter technicians on the team{" "}
          </li>
          <li className="text-sm mt-0.5 pb-8 border-b-2">
            Implemented the migration of technicians and the retail support team
            to our latest information-sharing platform, with the dual objectives
            of resolving knowledge gaps and facilitating a smoother onboarding
            experience for new associates.{" "}
          </li>
